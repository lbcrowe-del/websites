...
{
    /// <summary>
    /// Sends a transactional welcome email containing the license key.
    /// Implementations must never throw — log and swallow on failure.
    /// </summary>
    Task SendWelcomeEmailAsync(string toEmail, string? toName, string licenseKey, CancellationToken cancellationToken);
