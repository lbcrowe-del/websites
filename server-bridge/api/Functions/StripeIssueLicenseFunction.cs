...
public sealed class StripeIssueLicenseFunction
{
    ...
    private const string SuccessTemplate =
        ...
        "        <div style=\"font-size:2.5rem; margin-bottom:12px\">\U0001f389</div>" +
        "        <h2 style=\"margin-bottom:8px\">You're all set!</h2>" +
        "        <p style=\"margin-bottom:24px\">Thanks for purchasing ServerBridge Pro. " +
        "Here's your license key — copy it and keep it somewhere safe.</p>" +
        "        <div class=\"key-box\">" +
    ...
    private const string PendingPage =
        "<!DOCTYPE html>" +
        "<html lang=\"en\">" +
        "<head>" +
        "  <meta charset=\"utf-8\" />" +
        ...
        "        <p style=\"color:#6b7280\">This page will refresh automatically. " +
        "If it takes more than 30 seconds, <a href=\"mailto:hello@leecrowesoftware.com\">contact support</a>.</p>" +
        "      </div>" +
        "    </section>" +
        "  </main>" +
        "</body>" +
    ...
    private static string BuildPendingPage() => PendingPage;
